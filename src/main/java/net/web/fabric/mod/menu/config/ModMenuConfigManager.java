package net.web.fabric.mod.menu.config;

import com.google.common.collect.Sets;
import com.google.gson.*;
import net.web.fabric.mod.menu.ModMenu;
import net.web.fabric.mod.menu.config.option.*;
...
public class ModMenuConfigManager {
	...
	private static void prepareConfigFile() {
		...
		file = new File(FabricLoader.getInstance().getConfigDir().toFile(), "Websitemod" + ".json");
	}
